...
export function calc_short_route(start, destination, additions) {
    const ret = wasm.calc_short_route(start, destination, additions);
    return ret;
}
...
export function calc_weighted_routes(start, destinations, route_type, additions, avoid) {
    ...
    const ret = wasm.calc_weighted_routes(start, ptr0, len0, ptr1, len1, additions, ptr2, len2);
    return ret;
}
...
export const RouteType = Object.freeze({
    Safest: 0, "0": "Safest",
    Shortest: 1, "1": "Shortest",
    LessSafe: 2, "2": "LessSafe",
});

const ConnectionFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_connection_free(ptr >>> 0, 1));
...
export class Connection {
    ...
    constructor(source, target) {
        ...
        ConnectionFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
}

const NodeMapFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_nodemap_free(ptr >>> 0, 1));
...
export class NodeMap {
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        NodeMapFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_nodemap_free(ptr, 0);
    }
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbindgen_closure_wrapper276 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 47, __wbg_adapter_40);
        return ret;
    };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('eve_routes_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
